...
public class MyTags : MonoBehaviour
{
    ...
    public static string Top_Far_Tree = "TopFarTree";
    public static string Big_Tree = "BigTree";
    public static string Small_Tree = "SmallTree";
    public static string TopFarHouse = "TopFarHouse";
    ...
    public static string ChangeLane = "ChangeLane";
